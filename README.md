...
This project includes Docker support for easy deployment. The Dockerfile is configured to build a multi-stage image optimized for production use with AMD64 architecture.

### Building and Pushing Docker Image

A convenience script is provided to build and push the Docker image to Docker Hub:
...
docker build --platform=linux/amd64 -t hashiif/nusatoys:latest .

# Push to Docker Hub
docker push hashiif/nusatoys:latest
```
...
```bash
docker run -p 3000:3000 hashiif/nusatoys:latest
```
